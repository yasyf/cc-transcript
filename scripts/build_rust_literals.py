...
def literals() -> dict[str, str | float | tuple[str, ...]]:
    return {
        ...
        "protocol.TASK_NOTIFICATION_MARKER": TASK_NOTIFICATION_MARKER,
        "protocol.TOOL_USE_ID_PREFIX": TOOL_USE_ID_PREFIX,
        "protocol.TOOL_USE_ID_SUFFIX": TOOL_USE_ID_SUFFIX,
        "protocol.SENTIMENT_JUNK_PATTERN": group_pattern(SENTIMENT_JUNK_GROUPS),
