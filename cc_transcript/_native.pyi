...
__all__ = [
    ...
    "context_roundtrip",
    "cost_of_json",
    "decode_snapshot_events",
    "decode_snapshot_projection",
    "discovery_find_in",
...
@typing.final
class NativeSnapshotScope:
    def close(self) -> None: ...
    def checkpoint(self) -> None: ...
    def consume(self, events: builtins.int, items: builtins.int, output_bytes: builtins.int) -> None: ...
    def usage(self) -> builtins.str: ...
    def work(self) -> builtins.str: ...
    def description(self) -> builtins.str: ...
    def event_count(self) -> builtins.int: ...
    def source_facts(self, first_user_contains: builtins.str) -> builtins.str: ...
    def prose_page(self, start: builtins.int) -> builtins.str: ...
    def event(self, index: builtins.int) -> typing.Any: ...
    def classifier_facts(self, prefix: builtins.str, event_limit: builtins.int = 50) -> builtins.str: ...
    def activity(self, classifier_json: builtins.str, anchor_json: typing.Optional[builtins.str] = None, lookback: builtins.int = 40, lookahead: builtins.int = 120) -> dict: ...
    def mine(self, spec_json: builtins.str, callable_formats: typing.Sequence[tuple[builtins.str, typing.Any, typing.Any, builtins.bool]]) -> builtins.list[dict]: ...
    def capture(self, anchors_json: builtins.str, before: builtins.int = 6, after: builtins.int = 2, preview_chars: builtins.int = 200) -> builtins.str: ...
    def hydrate(self, windows_json: builtins.str, render_json: builtins.str) -> builtins.str: ...

@typing.final
class NativeSnapshotStore:
    def __new__(cls, config_json: builtins.str) -> NativeSnapshotStore: ...
    def default_registry_generation(self) -> builtins.str: ...
    def register_tool_registry(self, specs_json: builtins.str, context_json: builtins.str) -> builtins.str: ...
    def owner_epoch(self) -> builtins.str: ...
    def record_transport(self, bytes: builtins.int) -> None: ...
    def request(self, request_json: builtins.str, context_json: builtins.str, cancel: SnapshotCancellation) -> builtins.str: ...
    def discard_response(self, response_json: builtins.str, context_json: builtins.str) -> None: ...
    def publish_projection(self, request_json: builtins.str, context_json: builtins.str, cancel: SnapshotCancellation, metadata_json: builtins.str, field: builtins.str, records_json: list, usage_json: builtins.str, work_json: builtins.str) -> str: ...
    def resume_projection(self, cursor: builtins.str, context_json: builtins.str, cancel: SnapshotCancellation) -> typing.Optional[str]: ...
    def borrow(self, handle_json: builtins.str, context_json: builtins.str, limits_json: builtins.str, cancel: SnapshotCancellation) -> NativeSnapshotScope: ...
    def prepare_classifier(self, handle_json: builtins.str, classifier_json: builtins.str, context_json: builtins.str, cancel: SnapshotCancellation, limits_json: builtins.str) -> builtins.str: ...
    def submit_classifier(self, cursor: builtins.str, labels: list, context_json: builtins.str, cancel: SnapshotCancellation) -> builtins.str: ...
    def register_mining_policy(self, id: builtins.str, version: builtins.str, spec_json: builtins.str, callable_formats: typing.Sequence[tuple[builtins.str, typing.Any, typing.Any, builtins.bool]]) -> None: ...
    def register_classifier(self, id: builtins.str, version: builtins.str, callback: typing.Any) -> None: ...
...
class RustFeedbackStore:
    def __new__(cls, path: builtins.str, schema_identity: builtins.str, schema_ddl: builtins.str, event_columns: typing.Sequence[builtins.str], extension_paths: typing.Sequence[builtins.str], verdict_table: builtins.str, accepted_column: builtins.str, summary_column: builtins.str, event_filter: typing.Optional[builtins.str], readonly: builtins.bool = False, busy_timeout_ms: typing.Optional[builtins.int] = None) -> RustFeedbackStore: ...
    def open(self) -> asyncio.Future[None]: ...
    def close(self) -> asyncio.Future[None]: ...
...
class SnapshotCancellation:
    def __new__(cls) -> SnapshotCancellation: ...
...
class ToolCallBase:
    ...
    __match_args__: typing.ClassVar[tuple[str, ...]]
    @property
    def name_matcher(self) -> typing.Callable[[str], bool]:
        r"""
    ...
    def digest(self) -> ids.ToolDigest:
        ...
        """
    def matches(self, spec: builtins.str) -> builtins.bool:
        r"""
...
def activity_lift_tail(events: list[models.TranscriptEvent], opener_flags: typing.Optional[typing.Sequence[builtins.bool]] = None, open_turn: builtins.bool = False) -> dict[str, typing.Any]: ...
...
def decode_snapshot_events(records: typing.Sequence[builtins.str], max_bytes: builtins.int) -> list[models.TranscriptEvent]: ...

def decode_snapshot_projection(record_schema: builtins.str, records: typing.Sequence[builtins.str], max_bytes: builtins.int, tool_registry_json: typing.Optional[builtins.str] = None) -> list[typing.Any]: ...
...
def render_turn_from_events(prompt: builtins.str, events: list[models.TranscriptEvent], turn_chars: builtins.int, tool_chars: builtins.int, tool_results: builtins.bool) -> builtins.str: ...
