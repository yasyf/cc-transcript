...
def discovery_find_in(directory: builtins.str, name_contains: typing.Optional[builtins.str] = None, limit: typing.Optional[builtins.int] = None, known_mtimes: dict[str, float] | None = None) -> builtins.list[tuple[builtins.str, builtins.float]]: ...

def discovery_find_transcript(root: builtins.str, session_id: builtins.str) -> typing.Optional[builtins.str]: ...

def discovery_find_transcripts(root: builtins.str) -> builtins.list[builtins.str]: ...

def discovery_is_subagent_path(path: builtins.str) -> builtins.bool: ...

def discovery_subagent_paths(path: builtins.str) -> builtins.list[builtins.str]: ...

def discovery_subagent_transcripts(path: builtins.str) -> dict[str, str]: ...
