# cc-transcript Style Guide

The concrete style rules for `cc_transcript/`. Target Python 3.13+.
...
if TYPE_CHECKING:
    from cc_transcript.models import Record
...
def model_version() -> str:
    from cc_transcript.state import RESOURCES
